    ...
    variants: {
      orientation: {
        ...
        responsive: [
          ...
          "@md/field-group:has-[>[data-slot=field-content]]:items-start @md/field-group:has-[>[data-slot=field-content]]:[&>[role=checkbox]]:mt-px @md/field-group:has-[>[data-slot=field-content]]:[&>[role=radio]]:mt-px",
        ],
      },
    },
    defaultVariants: {
