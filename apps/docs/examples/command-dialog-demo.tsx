...
import { CommandDialog, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList } from "@blips/ui/components/command"
  ...
  return (
    <>
      <p className="text-sm text-muted-foreground">
        ...
        {" "}or{" "}
        <Button variant="outline" size="sm" onClick={() => setOpen(true)}>Open Command</Button>
      </p>
