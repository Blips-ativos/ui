...
// rehype-pretty-code transformers: stash the raw command on the <code> node so
// the copy button and the package-manager install tabs can read it. Mirrors
// shadcn/ui's docs pipeline.
